...
SECRET_KEY = 'django-insecure-6$b1aw(k9b8brm)ia^!da9cjvjjx!b*cxubm5$v%gb4+iwcf6r'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'pytherinDS@gmail.com'
EMAIL_HOST_PASSWORD = 'murtleMURTLE846$'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False

'''
#Dummy Email Server
#below is the command that gets added to the terminal to test the dummy email
